...
Tuttavia, l'aumento della potenza di calcolo e la velocità hanno incrementato i
...
basata sull'aggiunta di più unità di calcolo (cores), definendo dunque i
processori di ultima generazione \textbf{multicores}.
...
in precedenza, si basano sulla filosofia parallela.
...
Le architetture a memoria condivisa prevedono diverse unità di calcolo, ognuno
...
Le architetture basate sui sistemi ibridi non è nient'altro che un mix delle due
architetture viste in precedenza.
...
progettazione di un algoritmo parallelo \textit{nontrivial}:
