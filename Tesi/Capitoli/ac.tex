...
Nel caso di un automa cellulare bidimensionale, i vicinati più conosciuti sono
...
costituiscono siano strettamente vicine tra loro.
\begin{figure}[h]
\centering
...
\end{center}
\begin{itemize}
  \item $Z^d$ è l'insieme delle celle individuate da punti a coordinate intere
  ...
  cella \mbox{$i=<i_1,i_2,\ldots,i_d>$} in $Z^d$ come segue:\\
