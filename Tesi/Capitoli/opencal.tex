...
Alla base della nascita di OpenCAL troviamo la necessità di possedere una
...
più possibile i dettagli implementativi. Le funzioni, le strutture e i tipi di
...
enumerativo \texttt{CALNeighborhood2D} tramite cui è possibile scegliere tra i
...
dall'utente la gestione dell'aggiornamento dei sottostati. L'utente ha la possibilità di
definire il proprio ciclo di esecuzione e la modalità di aggiornamento dei
sottostati. Questo è reso possibile dalla funzione
...
L'implementazione è divisa sostanzialmente in due fasi ed in particolare nella
